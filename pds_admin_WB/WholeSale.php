    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <a href="BulkWholeSaleStatusChange.php" style="float:right;margin-top:10px;margin-right:13px"><button
                        type="button" class="btn btn-info">District-Wise Status Change</button></a>
                <a href="BulkWholeSaleDataEdit.php" style="float:right;margin-top:10px;margin-right:13px"><button
                        type="button" class="btn btn-warning">Bulk Data Edit</button></a>
                <a href="BulkWholeSaleData.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button"
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th style="font-size:16px">Name of WholeSale</th>
                                    <th style="font-size:16px">WholeSale ID</th>
                                    <th style="font-size:16px">Type</th>
                                    <th style="font-size:16px">Latitude</th>
                                    <th style="font-size:16px">Longitude</th>
                                    <th style="font-size:16px">Storage(Qtl)</th>
...
<script>
    ...
    function edit_entry(temp_id) {
        post({ uid: temp_id }, "WholeSaleEdit.php");
    }

    function change_status(temp_id) {
        post({ uid: temp_id }, "api/WholeSaleStatus.php");
    }
    ...
    function VerifyAndDelete() {
        ...
        post({ uid: temp_id, username: username, password: encrypted }, "api/WholeSaleDelete.php");
    }
    ...
    function fetchDataFromServer() {
        ...
        $.ajax({
            type: "POST",
            url: "api/fetchWholeSaleData.php",
            data: dataString,
            cache: false,
            error: function () {
                alert("timeout");
            ...
            success: function (result) {
                ...
                try {
                    ...
                    for (var datafield in obj) {
                        ...
                        var subpart = "<tr><td>" + obj[datafield]["district"] + "</td><td>" + obj[datafield]["name"] + "</td><td>" + obj[datafield]["id"] + "</td><td>" + obj[datafield]["type"] + "</td><td>" + obj[datafield]["latitude"] + "</td><td>" + obj[datafield]["longitude"] + "</td><td>" + obj[datafield]["storage"] + "</td><td>" + status + "</td><td> <button class='btn btn-info btn-rounded' onclick=\"change_status('" + temp_id + "')\">Change Status</button></td><td> <button class='btn btn-warning btn-rounded' onclick=\"edit_entry('" + temp_id + "')\">Edit</button></td><td> <button class='btn btn-danger btn-rounded' onclick=\"delete_entry('" + temp_id + "')\">Delete</button></td></tr>";
