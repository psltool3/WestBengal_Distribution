...
<script src="js/Encryption.js"></script>
                    ...
                    <div class="row">
                        <div class="col-md-12">
							...
							<div class="panel-heading">
								...
								<a href="BulkDepotStatusChange.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-info">District-Wise Status Change</button></a>
								<a href="BulkDepotDataEdit.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-warning">Bulk Data Edit</button></a>
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
												...
												<th style="font-size:16px">Name of Depot</th>
												<th style="font-size:16px">Depot ID</th>
												<th style="font-size:16px">Type</th>
												<th style="font-size:16px">Latitude</th>
												<th style="font-size:16px">Longitude</th>
												<th style="font-size:16px">Quantity of Raw Rice (Qtl)</th>
												<th style="font-size:16px">Quantity of Parboiled Rice (Qtl)</th>
    ...
    <!-- START SCRIPTS -->
		...
		function edit_entry(temp_id){
			post({uid: temp_id} ,"DepotEdit.php");
		}
		
		function change_status(temp_id){
			post({uid: temp_id} ,"api/DepotStatus.php");
		}
		...
		function VerifyAndDelete(){
			...
			post({uid: temp_id,username:username,password:encrypted} ,"api/DepotDelete.php");
		}
