...
if (isset($_GET['format'])) {
    ...
    $columns = ["district","name","id","latitude","longitude","demand", "demand_rice"];
	$columns1 = ["district","name","id","latitude","longitude","Quantity of Raw Rice", "Quantity of Praboiled Rice"];
