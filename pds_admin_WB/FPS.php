	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="panel panel-default">
				...
				<a href="BulkFPSStatusChange.php" style="float:right;margin-top:10px;margin-right:13px"><button
				...
				<a href="api/LoadFPSData.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button"
			...
			success: function (result) {
				...
				try {
					...
					for (var datafield in obj) {
						...
						var subpart = "<tr><td>" + obj[datafield]["district"] + "</td><td>" + obj[datafield]["name"] + "</td><td>" + obj[datafield]["id"] + "</td><td>" + obj[datafield]["type"] + "</td><td>" + obj[datafield]["latitude"] + "</td><td>" + obj[datafield]["longitude"] + "</td><td>" + obj[datafield]["demand"] + "</td><td>" + obj[datafield]["demand_wheat"] + "</td><td>" + obj[datafield]["demand_rice"] + "</td><td>" + obj[datafield]["demand_frice"] + "</td><td>" + status + "</td><td> <button class='btn btn-info btn-rounded' onclick=\"change_status('" + temp_id + "')\">Change Status</button></td><td> <button class='btn btn-warning btn-rounded' onclick=\"edit_entry('" + temp_id + "')\">Edit</button></td><td> <button class='btn btn-danger btn-rounded' onclick=\"delete_entry('" + temp_id + "')\">Delete</button></td></tr>";
