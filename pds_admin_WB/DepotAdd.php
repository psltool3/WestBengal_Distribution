                 ...
                 <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form action="api/DepotAdd.php" method="POST" class="form-horizontal" enctype = "multipart/form-data">
                             ...
                             <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
											...
											<div class="form-group">
                                                <label class="col-md-3 control-label">Raw Rice in Quintals*</label>
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-info"></span></span>
                                                        <input type="text" class="form-control" id="demand" name="demand" required />
                                                    </div>
                                                    <span class="help-block"> Raw Rice in Quintals</span>
                                                </div>
                                            </div>
											<div class="form-group">
                                                <label class="col-md-3 control-label">Parboiled Rice in Quintals*</label>
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-info"></span></span>
                                                        <input type="text" class="form-control" id="demand_rice" name="demand_rice" required />
                                                    </div>
                                                    <span class="help-block">Parboiled Rice in Quintals</span>
                                                </div>
                                            </div>
