                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="district" name="district"
                                                value="<?php echo $district ?>" readonly />
                                        </div>
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Demand of Atta in Quintals*</label>
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            <span class="input-group-addon"><span class="fa fa-info"></span></span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            <span class="input-group-addon"><span class="fa fa-info"></span></span>
                                            <input type="text" class="form-control" id="demand_wheat"
                                                name="demand_wheat" required />
                                        </div>
                                        <span class="help-block">Demand in Quintals</span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Demand of Parboiled_Rice in Quintals*</label>
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            <span class="input-group-addon"><span class="fa fa-info"></span></span>
                                            <input type="text" class="form-control" id="demand_frice"
                                                name="demand_frice" required />
                                        </div>
                                        <span class="help-block">Demand in Quintals</span>
                                    </div>
                                </div>
