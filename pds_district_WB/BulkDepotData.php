...
<script>
	function verifyCaptcha() {
		...
		document.getElementById("password").value = encrypted;
                ...
                <ul class="breadcrumb">
                    <li><a href="#">Home</a></li>
                    <li class="active">Depot Bulk Add</li>
                </ul>
                <!-- END BREADCRUMB -->
				...
				<!-- PAGE CONTENT WRAPPER -->
                 <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
							<a href="api/BulkDepotDownload.php" style="float:right;margin-top:10px;margin-right:13px"><button type="button" class="btn btn-info">Download Template</button></a>
                            <form action="api/BulkDepotData.php" method="POST" class="form-horizontal" enctype = "multipart/form-data">
